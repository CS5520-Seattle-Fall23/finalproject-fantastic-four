...
csv_file_path = "realData_waitBuyLinkAndContent.csv"  # Replace with the path to your CSV file
output_csv_file_path = 'buyLinkAndContent.csv'  # Replace with the path for the output data
