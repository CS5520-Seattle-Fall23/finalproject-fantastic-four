...
csv_file_path = "dogTreatment.csv"  # Replace with the path to your CSV file
output_csv_file_path = 'dogTreatment4_buyLink.csv'  # Replace with the path for the output data
