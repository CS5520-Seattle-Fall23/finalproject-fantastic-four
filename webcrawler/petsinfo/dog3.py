...
for i in range(1, 11):
    driver.get(f'https://slickdeals.net/newsearch.php?page=1&q=dog%20toy&searcharea=deals&searchin=first&isUserSearch=1')
    ...
    with open(csv_file_path, mode='a', encoding='utf-8', newline='') as f:
        ...
        for result in result_rows:
            ...
            print(f"Dog Toy Title: {title_text}")
            print(f"Store: {store}")
            print(f"Price: {price}")
    ...
    print(f'Dog Toy Collect Done page{i}')
